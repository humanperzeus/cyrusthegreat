...
import { Shield, Lock, Coins, ArrowUpDown, RefreshCw, Send, Link2, HeartHandshake, Compass } from "lucide-react";
...
export const VaultCore = ({ 
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 space-y-8">
      ...
      {/* Central Vault (the quick-action tiles now live INSIDE this card —
          see "Quick actions" below the vault status — so the dashboard is one
          integrated surface instead of a separate CTA card floating above). */}
      <div className="relative">
        ...
        <Card className="relative bg-gradient-card border-vault-primary/30 p-12 vault-glow vault-float">
          ...
          <div className="relative z-10 flex flex-col items-center space-y-6">
            ...
            {/* Quick actions — integrated INTO the dashboard (Revolut-style
                polished tiles), replacing the separate CTA card that used to
                float above the vault. Visible without a wallet; icons + labels
                + one-line subtitles. */}
            <div className="w-full">
              <p className="text-[11px] text-muted-foreground/70 text-center uppercase tracking-wide mb-3">Quick actions</p>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                <a href="/pay" className="group flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg bg-background/20 border border-vault-primary/20 hover:border-vault-primary/60 hover:bg-vault-primary/10 transition-all">
                  <div className="w-9 h-9 rounded-full bg-vault-primary/15 flex items-center justify-center group-hover:bg-vault-primary/25 transition-colors">
                    <Send className="w-4 h-4 text-vault-primary" />
                  </div>
                  <p className="text-xs font-semibold text-foreground">Pay anyone</p>
                  <p className="text-[9px] text-muted-foreground text-center leading-tight">private P2P</p>
                </a>
                <a href="/get-paid" className="group flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg bg-background/20 border border-vault-primary/20 hover:border-vault-primary/60 hover:bg-vault-primary/10 transition-all">
                  <div className="w-9 h-9 rounded-full bg-vault-primary/15 flex items-center justify-center group-hover:bg-vault-primary/25 transition-colors">
                    <Link2 className="w-4 h-4 text-vault-primary" />
                  </div>
                  <p className="text-xs font-semibold text-foreground">Get paid</p>
                  <p className="text-[9px] text-muted-foreground text-center leading-tight">create a pay link</p>
                </a>
                <a href="/fundraise" className="group flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg bg-background/20 border border-vault-primary/20 hover:border-vault-primary/60 hover:bg-vault-primary/10 transition-all">
                  <div className="w-9 h-9 rounded-full bg-vault-primary/15 flex items-center justify-center group-hover:bg-vault-primary/25 transition-colors">
                    <HeartHandshake className="w-4 h-4 text-vault-primary" />
                  </div>
                  <p className="text-xs font-semibold text-foreground">Fundraise</p>
                  <p className="text-[9px] text-muted-foreground text-center leading-tight">donation page</p>
                </a>
                <a href="/discover" className="group flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg bg-background/20 border border-vault-primary/20 hover:border-vault-primary/60 hover:bg-vault-primary/10 transition-all">
                  <div className="w-9 h-9 rounded-full bg-vault-primary/15 flex items-center justify-center group-hover:bg-vault-primary/25 transition-colors">
                    <Compass className="w-4 h-4 text-vault-primary" />
                  </div>
                  <p className="text-xs font-semibold text-foreground">Discover</p>
                  <p className="text-[9px] text-muted-foreground text-center leading-tight">browse campaigns</p>
                </a>
              </div>
              <p className="text-[10px] text-muted-foreground/50 text-center mt-2.5">No wallet needed to explore — connect only when you pay or withdraw.</p>
            </div>
      ...
      {/* Legal footer — Privacy + Disclaimer live at /privacy and /disclaimer
          (see App.tsx routes). Plain anchors: a full reload into a static
          legal page is fine and avoids pulling react-router into this file.
          Testnet-only reminder kept here too so it's visible site-wide. */}
      <div className="text-xs text-muted-foreground text-center p-2 flex items-center justify-center gap-2 flex-wrap">
        <a href="/privacy" className="text-vault-primary hover:text-vault-primary/80 transition-colors">Privacy</a>
        <span className="text-muted-foreground/40">·</span>
        <a href="/disclaimer" className="text-vault-primary hover:text-vault-primary/80 transition-colors">Disclaimer</a>
        <span className="text-muted-foreground/40">·</span>
        <span className="text-muted-foreground/70">Testnet only — no real funds</span>
      </div>

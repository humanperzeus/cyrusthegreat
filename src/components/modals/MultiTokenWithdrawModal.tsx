...
interface MultiTokenWithdrawModalProps {
  ...
  // Called when the withdrawal is submitted — parent closes both this
  // modal and its wrapping WithdrawModal so the global ProgressFlow
...
export function MultiTokenWithdrawModal({
  ...
  // Include native (address 0x0) — CrossChainBank8.withdrawMultipleTokens
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3 flex-1">
                        ...
                        <div className="flex gap-1">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              const formattedBalance = formatTokenBalance(withdrawal.token.balance, withdrawal.token.decimals);
                              updateWithdrawalAmount(index, formattedBalance);
                            }}
                            disabled={isLoading}
                        ...
                        <div className="text-sm text-gray-600">
                                                        Vault Balance: {formatTokenBalance(withdrawal.token.balance, withdrawal.token.decimals)} {withdrawal.token.symbol}
                        </div>
                      </div>
                      <Button
                        variant="ghost"
          ...
          <div className="flex justify-between space-x-3 pt-4 border-t">
            ...
            >
              {isValidating ? "Signing…" : `Withdraw ${withdrawals.length} Tokens`}
            </Button>
          </div>
        </div>
      </DialogContent>

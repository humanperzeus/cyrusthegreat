...
const Pay = () => {
  useSeo({
    title: "Send crypto payments — cyrusthegreat.dev",
    description: "Send multi-chain crypto payments across Ethereum, BSC, Base, Arbitrum and HyperEVM. Self-custodial, no account.",
    path: "/pay",
  });

...
const GetPaid = () => {
  useSeo({
    title: "Get paid in crypto — payment links & QR — cyrusthegreat.dev",
    description: "Create a crypto payment link or QR to get paid on any supported chain. Non-custodial, no signup.",
    path: "/get-paid",
  });
